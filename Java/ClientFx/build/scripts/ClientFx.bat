...
set DEFAULT_JVM_OPTS="--add-modules" "javafx.controls,javafx.fxml" "--module-path" "%APP_HOME%\lib" "--module" "Java.ClientFx.main/client.StartRpcClient"
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_FX_OPTS%  -classpath "%CLASSPATH%" client.StartRpcClient %*
